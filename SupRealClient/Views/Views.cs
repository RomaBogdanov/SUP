...
namespace SupRealClient.Views
{
    ...
    /// <summary>
    /// Логика взаимодействия для SelectedMainOrganisationStructureView.xaml - базовая часть для всех View
    /// </summary>
    public partial class SelectedMainOrganisationStructureView : IWindow
    {
        public bool CanMinimize { get; private set; } = true;

        public bool IsRealClose { get; set; } = true;

        public string WindowName { get; private set; } = "SelectedMainOrganisationStructureView";
    ...
    /// <summary>
    /// Логика взаимодействия для BidsListWindView.xaml - базовая часть для всех View
    /// </summary>
    public partial class BidsListWindView : IWindow
    {
        public bool CanMinimize { get; private set; } = true;

        public bool IsRealClose { get; set; } = true;

        public string WindowName { get; private set; } = "BidsListWindView";
    ...
    /// <summary>
    /// Логика взаимодействия для AssigningZonesView.xaml - базовая часть для всех View
    /// </summary>
    public partial class AssigningZonesView : IWindow
    {
        public bool CanMinimize { get; private set; } = true;

        public bool IsRealClose { get; set; } = true;

        public string WindowName { get; private set; } = "AssigningZonesView";
    ...
    /// <summary>
    /// Логика взаимодействия для DocumentImageView.xaml - базовая часть для всех View
    /// </summary>
    public partial class DocumentImageView : IWindow
    {
        public bool CanMinimize { get; private set; } = false;

        public bool IsRealClose { get; set; } = true;

        public string WindowName { get; private set; } = "DocumentImageView";
    ...
    /// <summary>
    /// Логика взаимодействия для ChangeStateView.xaml - базовая часть для всех View
    /// </summary>
    public partial class ChangeStateView : IWindow
    {
        public bool CanMinimize { get; private set; } = true;

        public bool IsRealClose { get; set; } = true;

        public string WindowName { get; private set; } = "ChangeStateView";
