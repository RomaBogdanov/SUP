...
-- Создание таблицы Arh_Cabinets
CREATE TABLE arh_cabinets
...
ALTER TABLE arh_cabinets
ADD CONSTRAINT pk_cabinets PRIMARY KEY (f_cabinet_id)

-- Создание таблицы arh_cabinets_zones

CREATE TABLE arh_cabinets_zones
    (f_cabinet_id                  int,
    f_zone_id                      int,
    f_cabinet_zone_id              int NOT NULL,
    f_arh_date                     DATE)

ALTER TABLE arh_cabinets_zones
ADD CONSTRAINT pk_cab_zon PRIMARY KEY (f_cabinet_zone_id)

-- Создание таблицы arh_cards
CREATE TABLE arh_cards
...
ALTER TABLE arh_cards
ADD CONSTRAINT pk_cards PRIMARY KEY (f_card_id)

-- Создание таблицы arh_countries

CREATE TABLE arh_countries
...
ALTER TABLE arh_countries
ADD CONSTRAINT pk_cntr PRIMARY KEY (f_cntr_id)

-- Создание таблицы arc_departament_sections

CREATE TABLE arh_departament_sections
...
ALTER TABLE arh_departament_sections
ADD CONSTRAINT pk_arh_dep_sec PRIMARY KEY (f_section_id)

-- Создание arh_departaments

CREATE TABLE arh_departaments
...
ALTER TABLE arh_departaments
ADD CONSTRAINT pk_arh_dep PRIMARY KEY (f_dep_id)

-- Создание arh_documents

CREATE TABLE arh_documents
...
ALTER TABLE arh_documents
ADD CONSTRAINT pk_doc PRIMARY KEY (f_doc_id)

-- Создание arh_order_elements

CREATE TABLE arh_order_elements
...
ALTER TABLE arh_order_elements
ADD CONSTRAINT pk_order_elements PRIMARY KEY (f_oe_id)

-- Создание arh_orderlist

CREATE TABLE arh_orderlist
    (f_ord_id                      int,
    f_visit_id                     int,
    f_deleted                      CHAR(1),
    f_arh_date                     DATE)
...
CREATE TABLE arh_orders
    (f_ord_id                      int NOT NULL,
    f_order_type_id                CHAR(18),
    f_reg_number                   int,
    f_ord_date                     DATE,
    f_date_from                    DATE,
    f_date_to                      DATE,
...
ALTER TABLE arh_orders
ADD CONSTRAINT pk_orders PRIMARY KEY (f_ord_id)

-- Создание arh_organizations

CREATE TABLE arh_organizations
...
ALTER TABLE arh_organizations
ADD CONSTRAINT pk_arh_org PRIMARY KEY (f_org_id)

-- Создание arh_spr_cardstates

CREATE TABLE arh_spr_cardstates
...
ALTER TABLE arh_spr_cardstates
ADD CONSTRAINT pk_spr_cardstates PRIMARY KEY (f_state_id)

-- Создание arh_spr_order_types

CREATE TABLE arh_spr_order_types
...
ALTER TABLE arh_spr_order_types
ADD CONSTRAINT pk_spr_order_types PRIMARY KEY (f_order_type_id)

-- Создание arh_temp_visitors

CREATE TABLE arh_temp_visitors
    (vis_id                         int)

-- Создание arh_visitors

CREATE TABLE arh_visitors
...
ALTER TABLE arh_visitors
ADD CONSTRAINT pk_visitors PRIMARY KEY (f_visitor_id)

-- Создание arh_visits

CREATE TABLE arh_visits
...
ALTER TABLE arh_visits
ADD CONSTRAINT pk_visits PRIMARY KEY (f_visit_id)

-- Создание arh_zone_types

CREATE TABLE arh_zone_types
...
ALTER TABLE arh_zone_types
ADD CONSTRAINT pk_zone_types PRIMARY KEY (f_zone_type_id)

-- Создание arh_zones

CREATE TABLE arh_zones
...
ALTER TABLE arh_zones
ADD CONSTRAINT pk_zones PRIMARY KEY (f_zone_id)

-- Создание arh_zones_order_elements

CREATE TABLE arh_zones_order_elements
    (f_zone_order_element_id       int NOT NULL,
    f_oe_id                        int,
    f_zone_id                      int,
    f_arh_date                     DATE)

ALTER TABLE arh_zones_order_elements
ADD CONSTRAINT pk_zones_order_elements PRIMARY KEY (f_zone_order_element_id)
