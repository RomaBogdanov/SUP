...
namespace SupTestClientConsole.TableServiceReference {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="TableServiceReference.ITableService", CallbackContract=typeof(SupTestClientConsole.TableServiceReference.ITableServiceCallback))]
    public interface ITableService {
        ...
        System.Data.DataTable GetTable(SupTestClientConsole.TableServiceReference.CompositeType composite, string login);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITableService/GetTable", ReplyAction="http://tempuri.org/ITableService/GetTableResponse")]
        System.Threading.Tasks.Task<System.Data.DataTable> GetTableAsync(SupTestClientConsole.TableServiceReference.CompositeType composite, string login);
        ...
        bool InsertRow(SupTestClientConsole.TableServiceReference.CompositeType composite, object[] objs, string login);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITableService/InsertRow", ReplyAction="http://tempuri.org/ITableService/InsertRowResponse")]
        System.Threading.Tasks.Task<bool> InsertRowAsync(SupTestClientConsole.TableServiceReference.CompositeType composite, object[] objs, string login);
        ...
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(SupTestClientConsole.TableServiceReference.TableName))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(object[]))]
        bool UpdateRow(SupTestClientConsole.TableServiceReference.CompositeType composite, int rowNumber, object[] objs, string login);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITableService/UpdateRow", ReplyAction="http://tempuri.org/ITableService/UpdateRowResponse")]
        System.Threading.Tasks.Task<bool> UpdateRowAsync(SupTestClientConsole.TableServiceReference.CompositeType composite, int rowNumber, object[] objs, string login);
        ...
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(SupTestClientConsole.TableServiceReference.TableName))]
        [System.ServiceModel.ServiceKnownTypeAttribute(typeof(object[]))]
        bool DeleteRow(SupTestClientConsole.TableServiceReference.CompositeType composite, object[] row, string login);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ITableService/DeleteRow", ReplyAction="http://tempuri.org/ITableService/DeleteRowResponse")]
        System.Threading.Tasks.Task<bool> DeleteRowAsync(SupTestClientConsole.TableServiceReference.CompositeType composite, object[] row, string login);
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class TableServiceClient : System.ServiceModel.DuplexClientBase<SupTestClientConsole.TableServiceReference.ITableService>, SupTestClientConsole.TableServiceReference.ITableService {
        ...
        public System.Data.DataTable GetTable(SupTestClientConsole.TableServiceReference.CompositeType composite, string login) {
            return base.Channel.GetTable(composite, login);
        }
        
        public System.Threading.Tasks.Task<System.Data.DataTable> GetTableAsync(SupTestClientConsole.TableServiceReference.CompositeType composite, string login) {
            return base.Channel.GetTableAsync(composite, login);
        }
        
        public bool InsertRow(SupTestClientConsole.TableServiceReference.CompositeType composite, object[] objs, string login) {
            return base.Channel.InsertRow(composite, objs, login);
        }
        
        public System.Threading.Tasks.Task<bool> InsertRowAsync(SupTestClientConsole.TableServiceReference.CompositeType composite, object[] objs, string login) {
            return base.Channel.InsertRowAsync(composite, objs, login);
        }
        
        public bool UpdateRow(SupTestClientConsole.TableServiceReference.CompositeType composite, int rowNumber, object[] objs, string login) {
            return base.Channel.UpdateRow(composite, rowNumber, objs, login);
        }
        
        public System.Threading.Tasks.Task<bool> UpdateRowAsync(SupTestClientConsole.TableServiceReference.CompositeType composite, int rowNumber, object[] objs, string login) {
            return base.Channel.UpdateRowAsync(composite, rowNumber, objs, login);
        }
        
        public bool DeleteRow(SupTestClientConsole.TableServiceReference.CompositeType composite, object[] row, string login) {
            return base.Channel.DeleteRow(composite, row, login);
        }
        
        public System.Threading.Tasks.Task<bool> DeleteRowAsync(SupTestClientConsole.TableServiceReference.CompositeType composite, object[] row, string login) {
